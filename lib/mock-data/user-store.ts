...
function createEmptyAvailability(userId: string): FacultyAvailability {
	return {
		...
		notes: null,
		days: [
			{ id: `day_mon_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.MONDAY, isAvailable: true, startTime: "09:00", endTime: "17:00" },
			{ id: `day_tue_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.TUESDAY, isAvailable: true, startTime: "09:00", endTime: "17:00" },
			{ id: `day_wed_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.WEDNESDAY, isAvailable: true, startTime: "09:00", endTime: "17:00" },
			{ id: `day_thu_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.THURSDAY, isAvailable: true, startTime: "09:00", endTime: "17:00" },
			{ id: `day_fri_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.FRIDAY, isAvailable: true, startTime: "09:00", endTime: "17:00" },
			{ id: `day_sat_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.SATURDAY, isAvailable: false, startTime: null, endTime: null },
			{ id: `day_sun_${userId}`, availabilityId: `availability_${userId}`, dayOfWeek: DayOfWeek.SUNDAY, isAvailable: false, startTime: null, endTime: null },
		],
	};
}
