...
CREATE INDEX idx_schedules_faculty_day ON faculty_schedules(faculty_id, day_of_week);
CREATE INDEX idx_schedules_faculty_active ON faculty_schedules(faculty_id, is_active);
...
CREATE TABLE faculty_availability_days (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_requests_faculty_status ON faculty_requests(faculty_id, status);
CREATE INDEX idx_requests_faculty_created ON faculty_requests(faculty_id, created_at DESC);

-- Faculty request timeline table
CREATE TABLE faculty_request_timeline (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_timeline_request ON faculty_request_timeline(request_id);
...
CREATE INDEX idx_notifications_faculty_read ON faculty_notifications(faculty_id, is_read);
CREATE INDEX idx_notifications_faculty_created ON faculty_notifications(faculty_id, created_at DESC);
